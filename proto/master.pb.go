...
type Command struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Command       string                 `protobuf:"bytes,1,opt,name=command,proto3" json:"command,omitempty"` // เช่น "restart", "stop"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_master_proto_rawDesc = "" +
	"\n" +
	"\x12proto/master.proto\x12\x05proto\"w\n" +
	"\n" +
	"NodeStatus\x12\x17\n" +
	...
	"proxyRules\"#\n" +
	"\aCommand\x12\x18\n" +
	"\acommand\x18\x01 \x01(\tR\acommand2\xe7\x01\n" +
	"\rMasterControl\x12/\n" +
	...
	".proto.AckB\tZ\a./protob\x06proto3"
...
var file_proto_master_proto_depIdxs = []int32{
	...
	1, // 4: proto.MasterControl.ReportStatus:output_type -> proto.Ack
	4, // 5: proto.MasterControl.GetConfig:output_type -> proto.ConfigResponse
	5, // 6: proto.MasterControl.GetCommand:output_type -> proto.Command
	1, // 7: proto.MasterControl.ManageContainer:output_type -> proto.Ack
